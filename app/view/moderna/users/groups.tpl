...
<tr>
	...
	<td>{$cat.name}</td>
	<td><a class="smoothbox" name="Grant access for the user group '<b>{$cat.name}</b>'" href="/userRights/?user_group_id={$cat.id}">{$this->myHelper->img_button("rights","Grant access for the user group")}</a>
