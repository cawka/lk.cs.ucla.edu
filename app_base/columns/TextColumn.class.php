...
class TextColumn extends BaseColumn 
{
	...
	{
		$ret="<input id='$this->myName' class=\"addann_input$this->myClass\" type='text' name='$this->myName' value='".$this->getValue( $row )."' ";
		if( $this->myToolTip!="" ) $ret.=" onmouseover=\"Tip('$this->myToolTip')\" ";
		if( $this->myLimit>0 ) $ret.=" MAXLENGTH='$this->myLimit' ";
		$ret.= "".(isset($this->myRequired)?"tmt:required='true' tmt:message='$this->myRequired'":"")." $this->myAdditional />".
		   	   " $this->myOptionMsg";
